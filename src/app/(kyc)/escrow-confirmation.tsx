  ...
  const handleConfirmPayment = async () => {
    ...
    try {
      ...
      if (escrowResponse.ok) {
        ...
        router.push(`/(kyc)/selection-type?escrowId=${escrowData.escrow_id}&verifierId=${verifierId}`)
      } else {
        ...
        <View style={{ paddingTop: 20, paddingBottom: 40 }}>
          ...
          >
            <View className="flex-row items-start">
              <Icon name="shield" size={20} style={{ marginTop: 2, marginRight: 12 }} />
          ...
          <Button
            text={isProcessing ? "Processing..." : `Pay ${verifierDetails.fee} ${verifierDetails.currency}`}
