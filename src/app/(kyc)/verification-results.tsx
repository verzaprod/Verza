...
export default function VerificationResults() {
  ...
  useEffect(() => {
    const fetchResults = async () => {
      try {
        const response = await fetch(`/api/verification/results/${escrowId}`)
    ...
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: theme.colors.background }}>
        <View className="flex-1 justify-center items-center">
          <Text style={{ color: theme.colors.textSecondary }}>Loading results...</Text>
        </View>
      </SafeAreaView>
    )
  }
      ...
      >
        <View style={{ paddingTop: 20, paddingBottom: 40 }}>
          <View style={{ alignItems: 'center', marginBottom: 32 }}>
            ...
            >
              {result.status === 'verified' ? 'Verification Complete!' : 'Verification Failed'}
            </Text>
          ...
          {result.status === 'verified' && result.vcDetails && (
            ...
            >
              ...
              <View style={{ gap: 12 }}>
                ...
                <View className="flex-row justify-between">
                  <Text style={{ color: theme.colors.textSecondary }}>Issuer</Text>
                  <Text style={{ color: theme.colors.textPrimary, fontWeight: '500' }}>
                ...
                <View className="flex-row justify-between">
                  <Text style={{ color: theme.colors.textSecondary }}>Issued</Text>
                ...
                <View className="flex-row justify-between">
                  <Text style={{ color: theme.colors.textSecondary }}>Expires</Text>
                  <Text style={{ color: theme.colors.textPrimary }}>
